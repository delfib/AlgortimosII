...
public class BreadthFirstEngine<S extends State, P extends StateProblem<S>> implements Engine<S,P>  {
    ...
    */
    ...
    /** 
    * Constructor for class BreadthFirstEngine.
    * @param sp is the search problem associated with the engine being created.
    * @pre. p!=null.
    ...
    */  
    ...
    /** 
    * Starts the search for successful states for problem, following a breadth-first strategy.
