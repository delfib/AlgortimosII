...
public class GreatestCommonDivisorTestDefBased {
	 ...
	 */
	public GreatestCommonDivisorTestDefBased(int m, int n){
		this.m = m;
		this.n = n;
	}
	...
	public void testIllegalArgumentException3(){
		int gcd = GreatestCommonDivisor.definitionBasedAlgorithm(0,1);
	}
	...
	public void testIllegalArgumentException4(){
		int gcd = GreatestCommonDivisor.definitionBasedAlgorithm(1,0);
	}
}