...
public class GreatestCommonDivisorTestMiddle {
	 ...
	 */
	public GreatestCommonDivisorTestMiddle(int m, int n){
		this.m = m;
		this.n = n;
	}
	...
	public static Collection<Object[]> parameters(){
		return Arrays.asList(new Object[][] {
			...
			{ 3, 7},
			{ 100, 7},
			//{ 0 , 39},	// me va a tirar error por tener como argumento 0 en el definitionBased
			//{ 39 , 0},	// ''
			{ 60, 20},
			{ 1770398451, 70398451},
		});
	...
	public void testIllegalArgumentException3(){
		int gcd = GreatestCommonDivisor.middleSchoolAlgorithm(0,1);
	}
	...
	public void testIllegalArgumentException4(){
		int gcd = GreatestCommonDivisor.middleSchoolAlgorithm(1,0);
	}
}